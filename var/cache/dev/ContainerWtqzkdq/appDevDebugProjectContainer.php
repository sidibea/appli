...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('jMmY6LjxVg', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NdCy0la89S', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('w1Zx10duRQ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pt-0N+N3v+', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ThisTokenIsNotSoSecretChangeItz'))) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/NB/AdminBundle/Resources/views'), 'NBAdmin');
        $instance->addPath(($this->targetDirs[3].'/src/NB/AdminBundle/Resources/views'), '!NBAdmin');
        $instance->addPath(($this->targetDirs[3].'/src/NB/CoreBundle/Resources/views'), 'NBCore');
        $instance->addPath(($this->targetDirs[3].'/src/NB/CoreBundle/Resources/views'), '!NBCore');
        $instance->addPath(($this->targetDirs[3].'/src/NB/WebBundle/Resources/views'), 'NBWeb');
        $instance->addPath(($this->targetDirs[3].'/src/NB/WebBundle/Resources/views'), '!NBWeb');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ThisTokenIsNotSoSecretChangeItz');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'NBAdminBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/NB/AdminBundle'),
                    'namespace' => 'NB\\AdminBundle',
                ],
                'NBCoreBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/NB/CoreBundle'),
                    'namespace' => 'NB\\CoreBundle',
                ],
                'NBWebBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/NB/WebBundle'),
                    'namespace' => 'NB\\WebBundle',
                ],
                'DebugBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'NBAdminBundle' => 'NB\\AdminBundle\\NBAdminBundle',
                'NBCoreBundle' => 'NB\\CoreBundle\\NBCoreBundle',
                'NBWebBundle' => 'NB\\WebBundle\\NBWebBundle',
            ...
            'database_host' => 'ata-center.ml',
            'database_port' => 3306,
            'database_name' => 'atacente_app',
            'database_user' => 'atacente_app',
            'database_password' => 'Sorofing123@!',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'mail.malinova.ml',
            'mailer_user' => 'sekou.sidibe@malinova.ml',
            'mailer_password' => 'Malinova@2020',
            'secret' => 'ThisTokenIsNotSoSecretChangeItz',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'ThisTokenIsNotSoSecretChangeItz',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'mail.malinova.ml',
            'swiftmailer.mailer.default.transport.smtp.username' => 'sekou.sidibe@malinova.ml',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Malinova@2020',
