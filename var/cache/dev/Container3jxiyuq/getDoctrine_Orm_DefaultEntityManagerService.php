...
if ($lazyLoad) {
    return $this->services['doctrine.orm.default_entity_manager'] = $this->createProxy('EntityManager_9a5be93', function () {
        return new \EntityManager_9a5be93(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/NB/CoreBundle/Entity')]), 'NB\\CoreBundle\\Entity');

$a->setEntityNamespaces(['NBCoreBundle' => 'NB\\CoreBundle\\Entity']);
